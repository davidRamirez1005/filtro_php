...
class connect {
    ...
    function __construct(){
        try {
            ...
            //  Aquí se establece un atributo en la conexión PDO para habilitar el modo de excepción. Esto significa que PDO lanzará excepciones en caso de errores en las consultas SQL. para mejorar la seguridad del servidor
